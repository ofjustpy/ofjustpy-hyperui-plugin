...
def GradientBorder(date, title, tags):
    with writer_ctx:
        with Article(classes="max-w-xl hover:animate-background rounded-xl bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 p-0.5 shadow-xl transition  hover:shadow-sm ") as comp_box:
